...
console.log('Date change:', copied.date !== holidays[christmas].date);
...
console.log('The first holiday in the year:', formatDate(firstHoliday));
console.log('The last holiday in the year:', formatDate(lastHoliday));

const randomIndex = Math.floor(Math.random() * 9);
const randomHoliday = holidays[randomIndex];
const formattedRandomDate = formatDate(randomHoliday.date);

console.log('Random holiday date:', formattedRandomDate);
